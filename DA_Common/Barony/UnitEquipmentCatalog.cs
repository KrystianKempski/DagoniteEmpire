namespace DA_Common.Barony
{
    ...
    public static class UnitWeaponCatalog
    {
        public static readonly IReadOnlyList<UnitWeaponDef> All = new[]
        {
            ...
            // Military melee
            W("longswords", "Longswords", "military", "melee", "Swords", 2, 2, 2, 0, 0, 0, true, 2, 2, 50, 20, 80),
            W("battle-axes", "Battle axes", "military", "melee", "Heavy weapons", 0, 3, 0, 1, 0, 0, true, 3, 2, 40, 15, 60),
            ...
            W("zweihanders", "Zweihanders", "military", "melee", "Swords", 4, 4, 1, 1, 0, 0, false, 4, 2, 100, 50, 230),
    ...
    public static class UnitArmorCatalog
    {
        public static readonly IReadOnlyList<UnitArmorDef> All = new[]
        {
            ...
            A("wooden-medium-shield", "Wooden medium shield", "shields", true, 3, 0, 0, -1, 2, 3, 25, 9, 30),
            A("wooden-large-shield", "Wooden large shield", "shields", true, 4, 0, -1, -2, 3, 5, 40, 12, 50),
            // Simple armor
            ...
            A("studded-buckler", "Studded buckler", "shields", true, 2, 0, 0, 0, 2, 1, 25, 8, 30),
            A("studded-medium-shield", "Studded medium shield", "shields", true, 3, 0, 0, -1, 3, 3, 40, 15, 50),
            A("studded-large-shield", "Studded large shield", "shields", true, 5, 0, -1, -2, 3, 5, 60, 25, 80),
            ...
            // Heavy
            A("metal-buckler", "Metal buckler", "shields", true, 2, 0, 0, 0, 2, 1, 40, 20, 60),
            A("metal-medium-shield", "Metal medium shield", "shields", true, 3, 0, 0, -1, 4, 3, 65, 35, 90),
            A("metal-large-shield", "Metal large shield", "shields", true, 5, 0, -1, -2, 4, 5, 85, 40, 120),

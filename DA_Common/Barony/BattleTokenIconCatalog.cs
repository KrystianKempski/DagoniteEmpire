...
namespace DA_Common.Barony
{
    ...
    public static class BattleTokenIconCatalog
    {
        public static IReadOnlyList<BattleTokenIcon> All { get; } = new BattleTokenIcon[]
        {
            ...
            new("bull", "Charging bull", "icons/charging-bull.svg"),
            new("hound", "Hound", "icons/hound.svg"),
            new("raven", "Raven", "icons/raven.svg"),
            new("snake", "Snake", "icons/snake.svg"),
            new("scorpion", "Scorpion", "icons/scorpion.svg"),
            new("octopus", "Octopus", "icons/octopus.svg"),

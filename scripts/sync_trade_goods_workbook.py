...
GOODS: list[dict] = [
    {"key": "salt", "category": "Mines & stone", "name": "Salt",
     ...
     "bonus": "+5% Food", "unlocks": "Meat saltery", "building": "Mine - Salt", "requires": "salt deposit"},
    ...
    {"key": "cattle", "category": "Food", "name": "Cattle",
     ...
     "bonus": "+1 Economy, +1 Production", "unlocks": "Cheese dairy, Tannery", "building": "Pastures (cattle)", "requires": "fertile land (3+)"},
    ...
    {"key": "honey-wax", "category": "Wood & forest", "name": "Honey & wax",
     ...
     "bonus": "+1 Loyalty, +1 Science", "unlocks": "Candlemaker", "building": "Apiary", "requires": "rich forest (3+)"},
    ...
    {"key": "wool", "category": "Fibers & hides", "name": "Wool",
     ...
     "bonus": "+1 Production, +1 Economy", "unlocks": "", "building": "Sheep pastures", "requires": "fertile terrain (2+)"},
    {"key": "sheep", "category": "Fibers & hides", "name": "Sheep",
     "description": "Breeding flocks for wool, meat, and manure. Stock must be obtained before pastures can be founded.",
     "bonus": "+1 Food, +1 Loyalty", "unlocks": "Sheep pastures", "building": "Sheep pastures", "requires": "fertile terrain (2+)"},
    {"key": "flax-hemp", "category": "Fibers & hides", "name": "Flax & hemp",
     "description": "Fiber for linen, rope, and sails.",
     "bonus": "+1 Production, +1 Stability", "unlocks": "", "building": "Flax farm", "requires": "fertile terrain (2+)"},
    {"key": "cloth", "category": "Fibers & hides", "name": "Cloth",
     "description": "Finished cloth for clothing, uniforms, and export.",
     "bonus": "+1 Economy, +1 Culture", "unlocks": "", "building": "Weaver's workshop", "requires": "flax / wool / cotton"},
    {"key": "cotton", "category": "Fibers & hides", "name": "Cotton",
     "description": "Raw cotton; grows in warm, fertile fields.",
     "bonus": "+1 Production, +1 Loyalty", "unlocks": "", "building": "Cotton farm", "requires": "fertile land (3+), warm climate"},
    {"key": "woad", "category": "Fibers & hides", "name": "Woad",
     "description": "Blue dye from woad leaves (Isatis tinctoria)—the staple blue of medieval cloth.",
     "bonus": "+1 Culture", "unlocks": "Dyer's workshop", "building": "Farm (Dye plant)", "requires": "fertile land (2+)"},
    {"key": "madder", "category": "Fibers & hides", "name": "Madder",
     "description": "Red dye from madder root (Rubia tinctorum)—rich crimsons for cloth and banners.",
     "bonus": "+1 Production", "unlocks": "Dyer's workshop", "building": "Farm (Dye plant)", "requires": "fertile land (2+)"},
    {"key": "weld", "category": "Fibers & hides", "name": "Weld",
     "description": "Yellow dye from weld (Reseda luteola)—bright mordant yellows and greens when mixed.",
     "bonus": "+1 Economy", "unlocks": "Dyer's workshop", "building": "Farm (Dye plant)", "requires": "fertile land (2+)"},
    {"key": "leather", "category": "Fibers & hides", "name": "Leather",
     "description": "Tanned hides for footwear, straps, and light armor.",
     "bonus": "+1 Production, +1 Defense", "unlocks": "Light armor (units)", "building": "Tannery", "requires": "cattle"},
    ...
    {"key": "dyes", "category": "Craft goods", "name": "Dyes",
     ...
     "bonus": "+1 Culture, +1 Production", "unlocks": "", "building": "Dyer's workshop", "requires": "woad / madder / weld"},
    ...
    {"key": "soft-metals", "category": "Mines & stone", "name": "Soft metals (Cu, Sn, Pb)",
     ...
     "bonus": "+1 Production", "unlocks": "Smithy", "building": "Mine - soft metals", "requires": "soft metals deposit"},
    {"key": "iron", "category": "Mines & stone", "name": "Iron",
     "description": "Iron ore and blooms; foundation of tools and military arms.",
     "bonus": "+1 Production, +1 Defense", "unlocks": "Forge, Armorer, Plate Workshop", "building": "Mine - Iron", "requires": "iron deposit"},
    ...
    {"key": "clay", "category": "Mines & stone", "name": "Clay",
     ...
     "bonus": "+1 Production, +1 Economy", "unlocks": "Potter's workshop, Brickyard", "building": "Clay pit", "requires": "clay deposit"},
    ...
    {"key": "elven-alder", "category": "Wood & forest", "name": "Elven alder",
     ...
     "bonus": "+1 Culture, +1 Magic", "unlocks": "Superior bows", "building": "Sawmill - Elven alder", "requires": "elven alder"},
    ...
    {"key": "horses", "category": "Arms & horses", "name": "Horses",
     ...
     "bonus": "+1 Defense, +1 Production", "unlocks": "Light cavalry", "building": "Horse Stud (regular)", "requires": "fertile land"},
    {"key": "war-horses", "category": "Arms & horses", "name": "War horses",
     "description": "Trained chargers for medium and heavy cavalry.",
     "bonus": "+2 Defense", "unlocks": "Medium and heavy cavalry", "building": "Horse Stud (military)", "requires": ""},
    {"key": "noble-horses", "category": "Arms & horses", "name": "Noble horses",
     "description": "Show and tourney breeds.",
     "bonus": "+1 Culture, +1 Loyalty", "unlocks": "", "building": "Horse Stud (noble)", "requires": ""},
    {"key": "sulfur", "category": "Mines & stone", "name": "Sulfur",
     "description": "Sulfur from mines; gunpowder and alchemy.",
     "bonus": "+1 Production, +1% Food", "unlocks": "Gunsmith workshop", "building": "Mine - Sulfur", "requires": "sulfur deposit"},
    {"key": "saltpeter", "category": "Craft goods", "name": "Saltpeter",
     "description": "Saltpeter for gunpowder; often produced near towns.",
     "bonus": "+1 Production, +1% Food", "unlocks": "Gunsmith workshop", "building": "Saltpeter works", "requires": "town"},
    {"key": "access-arms-military", "category": "Arms & horses", "name": "Military weapons",
     ...
     "bonus": "+2 Defense", "unlocks": "Units: military weapons", "building": "Forge", "requires": "iron"},
    ...
    {"key": "access-armor-light", "category": "Arms & horses", "name": "Light armor",
     ...
     "bonus": "+2 Defense", "unlocks": "Units: light armor", "building": "Tannery", "requires": "leather"},
    {"key": "access-armor-medium", "category": "Arms & horses", "name": "Medium armor",
     "description": "Mail, cuirasses, and brigandine.",
     "bonus": "+2 Defense", "unlocks": "Units: medium armor", "building": "Armorer", "requires": "leather, iron"},
    {"key": "access-armor-heavy", "category": "Arms & horses", "name": "Heavy armor",
     "description": "Plate and partial plate harness.",
     "bonus": "+2 Defense", "unlocks": "Units: heavy armor", "building": "Plate Workshop", "requires": "leather, iron"},
    ...
    {"key": "dagoferryt", "category": "Mines & stone", "name": "Dagoferryt",
     ...
     "bonus": "+2 Defense", "unlocks": "Weapons (good quality)", "building": "Mine - Dagoferryt", "requires": "dagoferryt deposit"},
...
UNLOCKS_PL_TO_EN: dict[str, str] = {
    ...
    "broń wojskowa, normal quality weapon, blacksmith workshop": "Military weapons, normal quality, Forge",
    "broń wojskowa, normal quality weapon, forge": "Military weapons, normal quality, Forge",
...
def translate_requires_pl(pl: str | None) -> str:
    ...
    repl = {
        ...
        "żródło bawnika": "woad / madder / weld",
        "źródło barwnika": "woad / madder / weld",
        "źródło bawnika": "woad / madder / weld",
    }

...
_GOODS_FALLBACK = [
    ('salt', 'Mines', 'Salt', 'Salt from mines or brine works; preserves food and supports long-distance trade.',
     '+5% Food', 'Meat saltery', 'Mine - Salt', 'salt deposit', {}, {"Food": 5.0}),
    ...
    ('cattle', 'Food', 'Cattle', 'Herds on pasture; meat, hides, wool, and draft power.',
     '+1 Economy, +1 Production', 'Cheese dairy, Tannery', 'Pastures (cattle)', 'fertile land (3+)', {"Economy": 1.0, "Production": 1.0}, {}),
    ...
    ('honey-wax', 'Wood', 'Honey & wax', 'Honey and beeswax from apiaries; sweetener, candles, and crafts.',
     '+1 Loyalty, +1 Science', 'Candlemaker', 'Apiary', 'rich forest (3+)', {"Loyalty": 1.0, "Science": 1.0}, {}),
    ...
    ('wool', 'Fibers', 'Wool', 'Raw wool from sheep; spun into yarn and cloth.',
     '+1 Production, +1 Economy', '', 'Sheep pastures', 'fertile terrain (2+)', {"Production": 1.0, "Economy": 1.0}, {}),
    ('sheep', 'Fibers', 'Sheep', 'Breeding flocks for wool, meat, and manure. Stock must be obtained before pastures can be founded.',
     '+1 Food, +1 Loyalty', 'Sheep pastures', 'Sheep pastures', 'fertile terrain (2+)', {"Food": 1.0, "Loyalty": 1.0}, {}),
    ('flax-hemp', 'Fibers', 'Flax & hemp', 'Fiber for linen, rope, and sails.',
     '+1 Production, +1 Stability', '', 'Flax farm', 'fertile terrain (2+)', {"Production": 1.0, "Stability": 1.0}, {}),
    ('cloth', 'Fibers', 'Cloth', 'Finished cloth for clothing, uniforms, and export.',
     '+1 Economy, +1 Culture', '', "Weaver's workshop", 'flax / wool / cotton', {"Economy": 1.0, "Culture": 1.0}, {}),
    ('cotton', 'Fibers', 'Cotton', 'Raw cotton; grows in warm, fertile fields.',
     '+1 Production, +1 Loyalty', '', 'Cotton farm', 'fertile land (3+), warm climate', {"Production": 1.0, "Loyalty": 1.0}, {}),
    ('woad', 'Fibers', 'Woad', 'Blue dye from woad leaves (Isatis tinctoria)—the staple blue of medieval cloth.',
     '+1 Culture', 'Dyer\'s workshop', 'Farm (Dye plant)', 'fertile land (2+)', {"Culture": 1.0}, {}),
    ('madder', 'Fibers', 'Madder', 'Red dye from madder root (Rubia tinctorum)—rich crimsons for cloth and banners.',
     '+1 Production', 'Dyer\'s workshop', 'Farm (Dye plant)', 'fertile land (2+)', {"Production": 1.0}, {}),
    ('weld', 'Fibers', 'Weld', 'Yellow dye from weld (Reseda luteola)—bright mordant yellows and greens when mixed.',
     '+1 Economy', 'Dyer\'s workshop', 'Farm (Dye plant)', 'fertile land (2+)', {"Economy": 1.0}, {}),
    ('leather', 'Fibers', 'Leather', 'Tanned hides for footwear, straps, and light armor.',
     '+1 Production, +1 Defense', 'Light armor (units)', 'Tannery', 'cattle', {"Production": 1.0, "Defense": 1.0}, {}),
    ...
    ('dyes', 'Crafts', 'Dyes', 'Dyes and fixatives for cloth and banners.',
     '+1 Culture, +1 Production', '', "Dyer's workshop", 'woad / madder / weld', {"Culture": 1.0, "Production": 1.0}, {}),
    ...
    ('soft-metals', 'Mines', 'Soft metals (Cu, Sn, Pb)', 'Copper, tin, and lead for tools, alloys, and simple weapons.',
     '+1 Production', 'Smithy', 'Mine - soft metals', 'soft metals deposit', {"Production": 1.0}, {}),
    ('iron', 'Mines', 'Iron', 'Iron ore and blooms; foundation of tools and military arms.',
     '+1 Production, +1 Defense', 'Forge, Armorer, Plate Workshop', 'Mine - Iron', 'iron deposit', {"Production": 1.0, "Defense": 1.0}, {}),
    ...
    ('clay', 'Mines', 'Clay', 'Clay from pits; raw material for bricks and pottery.',
     '+1 Production, +1 Economy', 'Potter\'s workshop, Brickyard', 'Clay pit', 'clay deposit', {"Production": 1.0, "Economy": 1.0}, {}),
    ...
    ('elven-alder', 'Wood', 'Elven alder', 'Rare bow- and luxury-grade wood from deep forests.',
     '+1 Culture, +1 Magic', 'Superior bows', 'Sawmill - Elven alder', 'elven alder', {"Culture": 1.0, "Magic": 1.0}, {}),
    ...
    ('horses', 'Military', 'Horses', 'Riding stock and light cavalry mounts.',
     '+1 Defense, +1 Production', 'Light cavalry', 'Horse Stud (regular)', 'fertile land', {"Defense": 1.0, "Production": 1.0}, {}),
    ('war-horses', 'Military', 'War horses', 'Trained chargers for medium and heavy cavalry.',
     '+2 Defense', 'Medium and heavy cavalry', 'Horse Stud (military)', None, {"Defense": 2.0}, {}),
    ('noble-horses', 'Military', 'Noble horses', 'Show and tourney breeds.',
     '+1 Culture, +1 Loyalty', '', 'Horse Stud (noble)', None, {"Culture": 1.0, "Loyalty": 1.0}, {}),
    ('sulfur', 'Mines', 'Sulfur', 'Sulfur from mines; gunpowder and alchemy.',
     '+1 Production, +1% Food', 'Gunsmith workshop', 'Mine - Sulfur', 'sulfur deposit', {"Production": 1.0}, {"Food": 1.0}),
    ('saltpeter', 'Crafts', 'Saltpeter', 'Saltpeter for gunpowder; often produced near towns.',
     '+1 Production, +1% Food', 'Gunsmith workshop', 'Saltpeter works', 'town', {"Production": 1.0}, {"Food": 1.0}),
    ('access-arms-military', 'Military', 'Military weapons', 'Standing access to military-grade arms: swords, polearms, war bows.',
     '+2 Defense', 'Units: military weapons', 'Forge', 'iron', {"Defense": 2.0}, {}),
    ...
    ('access-armor-light', 'Military', 'Light armor', 'Leather, caps, and padded protection.',
     '+2 Defense', 'Units: light armor', 'Tannery', 'leather', {"Defense": 2.0}, {}),
    ('access-armor-medium', 'Military', 'Medium armor', 'Mail, cuirasses, and brigandine.',
     '+2 Defense', 'Units: medium armor', 'Armorer', 'leather, iron', {"Defense": 2.0}, {}),
    ('access-armor-heavy', 'Military', 'Heavy armor', 'Plate and partial plate harness.',
     '+2 Defense', 'Units: heavy armor', 'Plate Workshop', 'leather, iron', {"Defense": 2.0}, {}),
    ...
    ('dagoferryt', 'Mines', 'Dagoferryt', 'Rare metal for the finest weapons and armor.',
     '+2 Defense', 'Weapons (good quality)', 'Mine - Dagoferryt', 'dagoferryt deposit', {"Defense": 2.0}, {}),

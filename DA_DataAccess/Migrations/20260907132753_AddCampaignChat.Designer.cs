...
namespace DA_DataAccess.Migrations
{
    ...
    [Migration("20260907132753_AddCampaignChat")]
    partial class AddCampaignChat
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DA_DataAccess.BaronyData.BaronyHallAdventure", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DA_DataAccess.Chat.CampaignChatMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("RecipientCharacterId");

                    b.HasIndex("SenderCharacterId");

                    b.HasIndex("CampaignId", "RecipientCharacterId", "CreatedDate");

                    b.HasIndex("CampaignId", "SenderCharacterId", "CreatedDate");

                    b.ToTable("CampaignChatMessages");
                });

            modelBuilder.Entity("DA_DataAccess.Chat.CampaignChatRead", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int?>("PeerCharacterId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CampaignId", "CharacterId", "PeerCharacterId");

                    b.ToTable("CampaignChatReads");
                });
            ...
            modelBuilder.Entity("DA_DataAccess.Notifications.WebPushSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DA_DataAccess.BaronyData.AvailableAdvisorDuty", b =>
                {
                    b.HasOne("DA_DataAccess.BaronyData.AvailableAdvisor", null)
                        .WithMany("Duties")
                        .HasForeignKey("AvailableAdvisorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("DA_DataAccess.Chat.CampaignChatMessage", b =>
                {
                    ...
                    b.HasOne("DA_DataAccess.CharacterClasses.Character", "RecipientCharacter")
                        .WithMany()
                        .HasForeignKey("RecipientCharacterId");

                    b.HasOne("DA_DataAccess.CharacterClasses.Character", "SenderCharacter")
                        .WithMany()
                    ...
                    b.Navigation("RecipientCharacter");

                    b.Navigation("SenderCharacter");
                });
